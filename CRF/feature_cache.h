...
class FeatureCache: public std::vector <int *> {
 ...
 public:
  ...
  explicit FeatureCache(): feature_freelist_(8192 * 32) {}
  virtual ~FeatureCache() {}
};

class FeatureValueCache: public std::vector <double *> {
 private:
  FreeList<double> feature_freelist_;
 ...
 public:
  ...
  explicit FeatureValueCache(): feature_freelist_(8192 * 64) {}
  virtual ~FeatureValueCache() {}
